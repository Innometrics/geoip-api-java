...
public class CityLookupV6Test {
	...
	public void testCityLookupV6() throws IOException {
		...
		LookupService cl = new LookupService(
                "src/test/resources/GeoIP/GeoLiteCityv6.dat", LookupService.DBType.MEMORY_CACHE);
		...
		assertEquals(103.80000, l2.longitude, DELTA);
		assertEquals(11074.877266, l2.distance(l1), DELTA);
		assertEquals(11074.877266, l1.distance(l2), DELTA);
